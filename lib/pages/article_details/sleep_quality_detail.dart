      ...
      children: [
        ...
        RichText(
          text: const TextSpan(
            ...
            children: [
              TextSpan(text: 'The difference between "getting sleep" and "getting rest" lies in '),
              TextSpan(text: 'sleep hygiene', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
              TextSpan(text: '—the habits and practices that are conducive to sleeping well on a regular basis.'),
            ],
          ),
        ),
        ...
        _buildRuleItem('0', 'the number of times you hit the snooze button in the morning.'),
        ...
        RichText(
          text: const TextSpan(
            ...
            children: [
              TextSpan(text: 'Our circadian rhythms are heavily influenced by '),
              TextSpan(text: 'light', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
              TextSpan(text: ' cues. Blue light, emitted by phones and laptops, suppresses melatonin production more '),
              TextSpan(text: 'than', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
              TextSpan(text: ' any other light spectrum. This tricks your '),
              TextSpan(text: 'brain', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
              TextSpan(text: ' into thinking '),
              TextSpan(text: 'it\'s still', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
        ...
        RichText(
          text: const TextSpan(
            ...
            children: [
              TextSpan(text: 'Your body temperature needs to drop by about 2-3 degrees Fahrenheit to initiate sleep. A room that is too warm will inhibit this process. The optimal '),
              TextSpan(text: 'bedroom temperature', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF111827))),
