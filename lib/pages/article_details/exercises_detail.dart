      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.medical_information_outlined, color: Color(0xFFDC2626), size: 20),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'These exercises are for mild discomfort. If you experience severe/shooting pain or leg numbness, stop immediately and consult your doctor.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
        ...
        _buildExerciseItem(
          ...
          placeholderColor: const Color(0xFFFFF7ED), // Light orange
          steps: [
        ...
        _buildExerciseItem(
          number: '2',
          title: 'Pelvic Tilts',
          placeholderColor: const Color(0xFFFEF3C7), // Light yellow
          steps: [
        ...
        _buildExerciseItem(
          number: '3',
          title: 'Knee-to-Chest',
          placeholderColor: const Color(0xFFE0E7FF), // Light indigo
          steps: [
        ...
        _buildExerciseItem(
          number: '5',
          title: 'Child\'s Pose',
          placeholderColor: const Color(0xFFD1FAE5), // Light emerald
          steps: [
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Center(
            child: Icon(Icons.fitness_center, size: 48, color: Colors.black.withOpacity(0.1)),
          ),
        ),
